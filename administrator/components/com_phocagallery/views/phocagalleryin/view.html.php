...
class PhocaGalleryCpViewPhocaGalleryIn extends JView
{
	...
	//	echo '<table border="1" cellpadding="5" cellspacing="5" style="border:1px solid #ccc;border-collapse:collapse">';
		...
		foreach ($function as $key => $value) {
			...
			$fOutput .=  '<td align="center">'.JHTML::_('image','administrator/components/com_phocagallery/assets/images/icon-16-true.png', JText::_('COM_PHOCAGALLERY_ENABLED') ).'</td>';
			$fOutput .=  '<td align="center">'. JHTML::_('image','administrator/components/com_phocagallery/assets/images/icon-16-'.$icon.'.png', JText::_($iconText)).'</td></tr>';
		...
		$fOutput .= '<tr '.$bgStyle.'><td>'.JText::_('COM_PHOCAGALLERY_FUNCTION') .' json_decode</td>';
		$fOutput .=  '<td align="center">'.JHTML::_('image','administrator/components/com_phocagallery/assets/images/icon-16-true.png', JText::_('COM_PHOCAGALLERY_ENABLED') ).'</td>';
		$fOutput .=  '<td align="center">'. JHTML::_('image','administrator/components/com_phocagallery/assets/images/icon-16-'.$icon.'.png', JText::_($iconText)).'</td></tr>';
	...
	protected function addToolbar() {
		JToolBarHelper::title( JText::_( 'COM_PHOCAGALLERY_PG_INFO' ), 'info.png' );
		JToolBarHelper::cancel( 'cancel', 'COM_PHOCAGALLERY_CLOSE' );
