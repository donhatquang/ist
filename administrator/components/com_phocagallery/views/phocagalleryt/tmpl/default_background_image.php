...
<?php echo JHTML::_('image', 'administrator/components/com_phocagallery/assets/images/image-bg-image.png', '' ); ?>
</div>
...
<tr>
	...
	<br />
	<?php echo '<img src="'.JURI::root().'/components/com_phocagallery/assets/images/shadow3.'.$this->tmpl['formaticon'] .'?imagesid='.md5(uniqid(time())) . '" alt="" />';
	?>
	</td>
</tr>
</table>
...
<tr>
	...
	<?php echo '(shadow3.'.$this->tmpl['formaticon'].')';?>
	<br />
	<?php echo '<img src="'.JURI::root().'/components/com_phocagallery/assets/images/shadow1.'.$this->tmpl['formaticon'] .'?imagesid='.md5(uniqid(time())) . '" alt="" />';
	//echo JHTML::_('image', 'components/com_phocagallery/assets/images/shadow1.'.$this->tmpl['formaticon'] .'?imagesid='.md5(uniqid(time())),'');
	?>
	</td>
</tr>
</table>
