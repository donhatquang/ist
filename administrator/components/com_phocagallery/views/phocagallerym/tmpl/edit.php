...
<script language="javascript" type="text/javascript">
	Joomla.submitbutton = function(task)
	{
		...
		if (task == 'phocagallerym.save') {
			phocagallerymform = document.getElementById('phocagallerym-form');
...
<form action="<?php JRoute::_('index.php?option=com_phocagallery'); ?>" method="post" name="adminForm" id="phocagallerym-form" class="form-validate">
