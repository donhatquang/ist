   		...
   		<tr>
							...
							<td>
								...
								<div style="float: left">
									<div class="icon hasTip" title="<?php echo JText::_('RSFP_SUPPORT'); ?>">
										<a href="index.php?option=com_rsform&amp;task=goto.support" target="_blank">
								...
								<div style="float: left">
									<div class="icon hasTip" title="<?php echo JText::_('RSFP_PLUGINS'); ?>">
										<a href="index.php?option=com_rsform&amp;task=goto.plugins" target="_blank">
		    ...
		    <td width="50%" valign="top" align="center">
			    <table border="1" width="100%" class="thisform">
			      ...
			      <img src="components/com_rsform/assets/images/rsformpro.png" align="middle" alt="RSForm! Pro logo"/>
			      <br /><br /></div>
			      </td></tr>
			         <tr class="thisform">
