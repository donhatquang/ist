...
<div id="shoutbox">
	<div id="chatoutput">
		...
		<?php foreach ($list as $item) : ?>
			...
			$lastID = $item->id; ?>
				<div id="lastMessage"><span>
				
				
				<?php echo JText::_( '最近留言'); ?>
                
                
                </span> <em id="responseTime"><?php echo modShoutboxHelper::time_since($item->time); ?> <?php echo JText::_( 'AGO'); ?></em></div><ul id="outputList">
			<?php endif; ?>
			<?php if ($maydelete): ?>
	...
	<form id="chatForm" name="chatForm" method="post" action="index.php">
		...
		<input type="submit" style="color:#000" id="submitchat" name="submit" class="button" value="<?php echo JText::_( 'SEND'); ?>" />
		<?php endif; ?>
