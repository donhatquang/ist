...
<thead>
	...
	<th class="title" width="15%"><?php echo JHTML::_('grid.sort',  'COM_PHOCAGALLERY_TITLE', 'a.title', $this->listsimage['order_Dir'], $this->listsimage['order'], 'image'); ?></th>
	<th width="3%" nowrap="nowrap"><?php echo JHTML::_('grid.sort',  'COM_PHOCAGALLERY_PUBLISHED', 'a.published', $this->listsimage['order_Dir'], $this->listsimage['order'], 'image' ); ?></th>
	<th width="3%" nowrap="nowrap"><?php echo JText::_('COM_PHOCAGALLERY_DELETE'); ?></th>
	<th width="3%" nowrap="nowrap"><?php echo JHTML::_('grid.sort',  'COM_PHOCAGALLERY_APPROVED', 'a.approved', $this->listsimage['order_Dir'], $this->listsimage['order'], 'image' ); ?></th>
	<th width="80" nowrap="nowrap" align="center">
	
	<?php echo JHTML::_('grid.sort',  'COM_PHOCAGALLERY_ORDER', 'a.ordering', $this->listsimage['order_Dir'], $this->listsimage['order'],'image' );
	...
	echo $href;
	?></th>
	<th width="3%" nowrap="nowrap"><?php echo JHTML::_('grid.sort', 'COM_PHOCAGALLERY_CATEGORY' , 'a.catid', $this->listsimage['order_Dir'], $this->listsimage['order'], 'image' ); ?></th>
	
	<th width="1%" nowrap="nowrap"><?php echo JHTML::_('grid.sort',  'COM_PHOCAGALLERY_ID', 'a.id', $this->listsimage['order_Dir'], $this->listsimage['order'] , 'image'); ?></th>
	</tr>
</thead>
...
if (is_array($rows)) {
	...
	echo JHTML::_('image',  $this->tmpl['pi'].'icon-trash.'.$this->tmpl['fi'], JText::_('COM_PHOCAGALLERY_DELETE')).'</a>';
	echo '</td>';
...
<?php
	...
	if ((int)$this->tmpl['displayupload'] == 1) {
		echo '<p><strong>'. JText::_('COM_PHOCAGALLERY_SINGLE_FILE_UPLOAD').'</strong></p>';
		echo $this->loadTemplate('upload');
	}
	
	if((int)$this->tmpl['enablemultiple']  == 1) {
		echo '<p><strong>'. JText::_('COM_PHOCAGALLERY_MULTPLE_FILE_UPLOAD').'</strong></p>';
		echo $this->loadTemplate('multipleupload');
	}

	if($this->tmpl['enablejava'] == 1) {
		echo '<p><strong>'. JText::_('COM_PHOCAGALLERY_JAVA_UPLOAD').'</strong></p>';
...
?><fieldset>
<legend><?php 
	echo JText::_( 'COM_PHOCAGALLERY_UPLOAD_IMAGE' ).' [ '. JText::_( 'COM_PHOCAGALLERY_MAX_SIZE' ).':&nbsp;'.$this->tmpl['uploadmaxsizeread'].','
...
?></legend>	<?php
		...
		if ($this->tmpl['enablejava'] == 1) {
			...
			?><p><strong><?php echo JText::_('COM_PHOCAGALLERY_JAVA_UPLOAD'); ?></strong></p>
			<!--[if !IE]> -->
			...
			<param name="maxPicHeight" value="<?php echo $this->tmpl['multipleresizeheight'] ?>" />
			<param name="maxPicWidth" value="<?php echo $this->tmpl['multipleresizewidth'] ?>" />
			...
			<p><strong><?php echo JText::_('COM_PHOCAGALLERY_SINGLE_FILE_UPLOAD'); ?></strong></p>
...
<table>
	<tr>
		<td><strong><?php echo JText::_('COM_PHOCAGALLERY_FILENAME');?>:</strong></td><td>
		...
		<tr>
			<td><strong><?php echo JText::_( 'COM_PHOCAGALLERY_IMAGE_TITLE' ); ?>:</strong></td>
...
<div id="loading-label" style="text-align:center"><?php echo JHTML::_('image', $this->tmpl['pi'].'icon-switch.gif', '') . '  '. JText::_('COM_PHOCAGALLERY_LOADING'); ?></div>
</fieldset>*/
