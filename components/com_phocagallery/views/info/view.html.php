...
*/	
		...
		if ($this->tmpl['detailwindow'] == 7) {
			...
			$this->tmpl['backbutton'] = '<div><a href="'.JRoute::_('index.php?option=com_phocagallery&view=category&id='. $info->catslug.'&Itemid='. JRequest::getVar('Itemid', 0, '', 'int')).'"'
							...
							switch ($name) {
								...
								case 'SensingMethod':
									switch((int)$exif[$section][$name]) {
										...
										case 2:
											$exifValue = JText::_('COM_PHOCAGALLERY_ONE-CHIP_COLOR_AREA SENSOR');
										break;
										case 3:
