    ...
    var style_name = jQuery('#jform_title').val();
            ...
            success: function(data) {
                ...
                jQuery('#toolbar-apply').children().click(function(){
                    jQuery.ajax({
                        ...
                        dataType: 'json',
                        data: {vertex: jQuery(form).serializeArray(), style: jQuery('#jform_template').val(), style_name: jQuery('#jform_title').val()},
                        success: function(data) {
                            javascript:Joomla.submitbutton('style.apply');
                        }
                    });
                    return false;
                });
                jQuery('#toolbar-save').children().click(function(){
                    jQuery.ajax({
                        ...
                        data: {vertex: jQuery(form).serializeArray(), style: jQuery('#jform_template').val(), style_name: jQuery('#jform_title').val()},
                        success: function(data) {
                            javascript:Joomla.submitbutton('style.save');
                        }
                    });
                    return false;
                });
                jQuery('#toolbar-save-copy').children().click(function(){
                    var style_name_copy = jQuery('#jform_title').val();
                    if(style_name_copy == style_name) {
                        jQuery('#jform_title').val(style_name_copy + ' (copy)');
                    }
                    jQuery.ajax({
                        type: 'POST',
                        url: vertex_ajax_url + '/saveOptions.php',
        ...
        jQuery(document).bind('vertex', function () {
            ...
            jQuery(function() {
                ...
                jQuery.ajax({
                    type: 'GET',
                    url: vertex_ajax_url + '/vertexCron.php',
                    dataType: 'json',
                    success: function(data) {
                ...
                jQuery.ajax({
                    ...
                    success: function(data) {
                        ...
                        jQuery('#showVertexMsg').empty().css({height: 30, width: 310}).append(data.update_link);
