...
class S5modMainMenuHelper
{
	...
	static function getList(&$params)
	{
		...
		$maxdepth	= (int) $params->get('s5_maxdepth');//$params->get('maxdepth');
		$items 		= $menu->getItems('menutype',$params->get('s5_menu_type'));//$params->get('menutype')
...
*/		//$items = &JSite::getMenu();
		...
		// Get Menu Items
		$rows = S5modMainMenuHelper::getList($params);//$items->getItems('menutype', $params->get('s5_menu_type'));
		$maxdepth = $params->get('s5_maxdepth',10);
